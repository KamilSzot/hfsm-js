...
(function() {
  var Regions, State, active, l, operational, util,
    slice = [].slice;
  ...
  State = (function() {
    ...
    State.prototype._enter = function() {
      var nextState, nextSubState, ref, ref1, ref2, ref3, ref4;
      nextState = arguments[0], nextSubState = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      ...
      return (ref4 = this._current)._enterDescend.apply(ref4, nextSubState);
    };

    State.prototype._enterDescend = function() {
      var nextSubState;
      nextSubState = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      if (this.enter) {
        this.enter();
      }
      if (nextSubState[0] || this._default || this._historyState || this._history || this._deepHistory) {
        return this._enter.apply(this, nextSubState);
      }
    };

    State.prototype.to = function() {
      var State;
      State = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      this._exit();
      return this._enter.apply(this, State);
    };
